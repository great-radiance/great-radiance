...
- Designing **production-grade AI workflows** — retrieval, tool use, evaluation, and guardrails
- Building **full-stack applications** where model intelligence meets thoughtful product design
- Sharing patterns for **shipping AI safely**: latency, cost, monitoring, and human-in-the-loop UX

---

## Philosophy

> *The best AI products feel inevitable — not because the model is magic, but because the engineering around it is disciplined.*
...
Open to collaborations, interesting problems, and conversations about AI engineering at scale.
